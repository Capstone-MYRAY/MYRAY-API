...
public interface IAttendanceRepository
{
    ...
    Task<DataTier.Entities.Attendance?> GetAttendance(int appliedJobId, int accountId, DateTime dateTime);
    ...
    IQueryable<MYRAY.DataTier.Entities.Attendance> GetListDayOffByJob(int farmerId, int? jobPostId = null);
