...
public class TestDataPath
{
    ...
    public static string AttendanceController =>
        Path.Combine(CurrentDirectory, "TestData", "AttendanceController.json");

    public static string AuthenticationController =>
        Path.Combine(CurrentDirectory, "TestData", "AuthenticationController.json");
    ...
    public static string ExtendTaskJobController =>
        Path.Combine(CurrentDirectory, "TestData", "ExtendTaskJobController.json");
    ...
    public static string PaymentHistoryController =>
        Path.Combine(CurrentDirectory, "TestData", "PaymentHistoryController.json");
